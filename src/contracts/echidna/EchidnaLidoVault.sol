...
contract EchidnaLidoVault is LidoVault(false) {
    function echidna_start_time_less_than_end_time()
        public
        view
        returns (bool)
    {
    ...
    function echidna_eth_deposit_less_than_fixed_side_capacity()
        public
        view
        returns (bool)
    {
    ...
    function echidna_variable_bearer_token_less_than_variable_side_capacity()
        public
        view
        returns (bool)
    {
    ...
    function echidna_protocol_fee_less_than_withdrawn_staking_earnings()
        public
        view
        returns (bool)
    {
    ...
    function echidna_protocol_fee_less_than_vault_ended_staking_earnings()
        public
        view
        returns (bool)
    {
        return
            appliedProtocolFee <=
            withdrawnStakingEarnings + vaultEndedStakingEarnings;
    }
}

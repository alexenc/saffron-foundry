...
contract MockLido is ILido {
    ...
    function addStakingEarningsForTargetETH(
        ...
        require(
            userShares > 0 &&
                (targetETHBalance * totalShares) >
                (userShares * totalPooledEther),
            "Invalid Shares"
        );

        uint256 earnings = ((targetETHBalance * totalShares) -
            (userShares * totalPooledEther)) / userShares;

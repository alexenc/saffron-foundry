...
contract MockLidoWithdrawalQueue is ILidoWithdrawalQueueERC721 {
    ...
    mapping(uint256 => ILidoWithdrawalQueueERC721.WithdrawalRequestStatus)
    ...
    function getWithdrawalStatus(
        ...
        view
        returns (
            ILidoWithdrawalQueueERC721.WithdrawalRequestStatus[] memory statuses
        )
    {
        ILidoWithdrawalQueueERC721.WithdrawalRequestStatus[]
            memory _statuses = new ILidoWithdrawalQueueERC721.WithdrawalRequestStatus[](
                _requestIds.length
            );
